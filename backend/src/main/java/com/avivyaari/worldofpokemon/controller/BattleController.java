...
public class BattleController {
    ...
    @PostMapping("/{trainer1Name}/{trainer2Name}")
    public BattleResponse doBattle(@PathVariable String trainer1Name, @PathVariable String trainer2Name) throws BattleException, CustomEntityNotFoundException {
